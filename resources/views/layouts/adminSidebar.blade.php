    <div class="border-end bg-white" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush recruiterLink">
            ...
            <a class="list-group-item list-group-item-action list-group-item-light" href="/adminApplicantsRoutes"><i class="bi bi-people-fill pe-3"></i> Applicant Details</a>
            ...
            {{-- <a class="list-group-item list-group-item-action list-group-item-light" href="/history"><i class="bi bi-pencil-square pe-3"></i> History</a> --}}
        </div>
