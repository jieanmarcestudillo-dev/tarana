                ...
                {{-- NAV BAR --}}
                    <nav class="navbar navbar-expand-lg text-white border-bottom">
                        <div class="container-fluid">
                            ...
                            <h4 class="ms-2">EMPLOYEES DETAILS</h4>
                        ...
                        <div class="">
                            <div class=" bg-light py-4 px-5 bg-body rounded shadow-lg">
                                <ul class="nav nav-tabs mb-2">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/adminEmployeesRoutes">&nbsp;&nbsp;Active Recruiter&nbsp;&nbsp;</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="/inactiveEmployees">Inactive Recruiter</a>
                                    </li>
                                    <li class="nav-item">
