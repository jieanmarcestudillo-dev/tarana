    ...
    function inactiveEmployeesTable(){
        var table = $('#inactiveEmployees').DataTable({
            ...
            "columns":[
                ...
                {"data": "employee_id",
                    mRender: function (data, type, row) {
                    return '<button type="button" data-title="Edit Employees?" onclick=updateEmployees('+data+') class="btn rounded-0 btn-outline-secondary btn-sm px-3 py-2"><i class="bi bi-pen-fill"></i></button> <button data-title="Activate This?" type="button" onclick=activateEmployees('+data+') class="btn rounded-0 btn-outline-success btn-sm px-3 py-2"><i class="bi bi-person-check-fill"></i></button>'
                }
                }
            ],
            order: [[1, 'asc']],
    ...
    function currentlyUtilizing(){
        var table = $('#utilizing').DataTable({
            ...
            "columns":[
                ...
                {"data": "employee_id",
                    mRender: function (data, type, row) {
                    return '<button type="button" onclick=unUtilizedAccount('+data+') class="btn rounded-0 ROUNDED-0 btn-outline-primary btn-sm py-2 px-3" data-title="Unutilized Applicants?"><i class="bi bi-person-bounding-box"></i></button>'
                }
                }
            ],
            order: [[1, 'asc']],
