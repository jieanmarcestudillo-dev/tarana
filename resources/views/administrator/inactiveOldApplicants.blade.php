                    ...
                    <div class="container-fluid mainBar">
                        <div class="container-fluid bg-light px-5 py-4 bg-body rounded shadow-lg">
                            <ul class="nav nav-tabs mb-4">
                                <li class="nav-item">
                                    <a class="nav-link" href="/adminOldApplicantsRoutes">Applicants</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="#">&nbsp;&nbsp;Inactive Applicants&nbsp;&nbsp;</a>
                                </li>
                                <li class="nav-item">
                                        <a class="nav-link" href="/blockedOldApplicantsRoutes">Blocked Applicants</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <div class="container-fluid mt-4">
                                <table id="inactiveOldApplicants" class="table table-sm table-bordered text-center align-middle">
                                    <thead>
                                        <tr>
