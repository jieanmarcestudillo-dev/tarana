    ...
    function inactiveApplicantsTable(){
        var table = $('#inactiveApplicants').DataTable({
            ...
            "columns":[
                ...
                {"data": "applicant_id",
                    mRender: function (data, type, row) {
                    return '<button type="button" data-title="View Applicant?" onclick=viewApplicants('+data+') class="btn rounded-0 rounded-0 btn-outline-secondary btn-sm px-3 py-2"><i class="bi bi-pencil-square"></i></button> <button type="button" onclick=activateApplicants('+data+') class="btn rounded-0 rounded-0 btn-outline-success btn-sm px-3 py-2" data-title="Activate Applicant?"><i class="bi bi-check-lg"></i></button> <button type="button" onclick=blockedApplicant('+data+') class="btn rounded-0 rounded-0 btn-outline-danger btn-sm px-3 py-2" data-title="Blocked Applicant?"><i class="bi bi-x-lg"></i></button> <a href="printProjectWorker/'+data+'" class="btn rounded-0 btn-outline-primary btn-sm py-2 px-3" data-title="Print this Applicant?"><i class="bi bi-filetype-pdf"></i></a>'
                    }
                }
            ],
            order: [[1, 'asc']],
    ...
    function blockApplicantsTable(){
        var table = $('#blockApplicants').DataTable({
            ...
            "columns":[
                ...
                {"data": "applicant_id",
                    mRender: function (data, type, row) {
                    return '<button type="button" data-title="View Applicant?" onclick=viewApplicants('+data+') class="btn rounded-0 btn-outline-secondary btn-sm py-2 px-3"><i class="bi bi-pencil-square"></i></button> <button type="button" onclick=unblockApplicant('+data+') class="btn rounded-0 btn-outline-success btn-sm py-2 px-3" data-title="Unblock?"><i class="bi bi-check-lg"></i></button> <a href="printProjectWorker/'+data+'" class="btn rounded-0 btn-outline-primary btn-sm py-2 px-3" data-title="Print this Applicant?"><i class="bi bi-filetype-pdf"></i></a>'
                    }
                }
            ],
            order: [[1, 'asc']],
