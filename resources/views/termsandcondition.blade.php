...
<head>
    ...
    <link href="{{ asset('/css/termsAndCondition/animate.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/css/termsAndCondition/style.css') }}" rel="stylesheet">
    <link href="{{ asset('/css/termsAndCondition/owl.carousel.min.css') }}" rel="stylesheet">
</head>
...
<body>
			...
			<div class="container">
				<nav class="navbar navbar-expand-md navbar-light">
					<a class="navbar-brand" href="#">
                        <img src="./assets/frontend/logo.webp" class="img-thumnail" width="50%" style="margin-top: -18px;">
					</a>
					<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
						...
						<div class="other-option">
							<a class="default-btn nav-btn-1" href="/applicantsAuthentication">Sign In <span></span></a>
							<a class="default-btn" href="/applicantSignUp">Sign Up <span></span></a>
						</div>
					</div>
				</nav>
			</div>
    ...
    <!-- FOOTER -->
    <script src="{{ asset('/js/termsAndCondition/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('/js/termsAndCondition/main.js') }}"></script>
