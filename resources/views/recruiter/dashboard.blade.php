...
<body>
                ...
                {{-- NAV BAR --}}
                    <nav class="navbar navbar-expand-lg text-white border-bottom">
                        <div class="container-fluid">
                            <h4 class="ms-2">MANPOWER POOLING DASHBOARD</h4>
                    ...
                    <div class="container-fluid mainBar">
                        ...
                        <div class="card rounded-0">
                            <ul class="nav nav-tabs mt-4">
                                <li class="nav-item">
                                    <a class="nav-link align-middle text-dark active" href="#">&nbsp;&nbsp;Pending Invitation&nbsp;&nbsp; <span class="badge rounded-circle bg-secondary align-middle" ></span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link align-middle text-secondary active" href="/recruiterApplicantsBackoutRoutes">Back Out On Operation <span class="badge rounded-circle bg-secondary align-middle" ></span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link align-middle text-secondary active" href="/recruiterApplicantDeclinedRoutes">Declined Invitation <span class="badge rounded-circle bg-secondary align-middle" ></span></span></a>
                                </li>
                            </ul>
                            <div class="mb-3">
                                <div class="card p-4 rounded-0" id="fetchAllPendingInvitation"></div>
                            </div>
                        </div>
                    </div>
                {{-- MAIN CONTENT --}}
    ...
    {{-- JS --}}
        ...
        <script src="{{ asset('/js/recruiter/dashboard.js') }}"></script>
                            ...
                            <form name="updateOperationForm" id="updateOperationForm">
                                ...
                                <div class="row g-1 mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control shadow-sm bg-body rounded" readonly id="updateShipsName" name="updateShipsName">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label">Ship's Carry:</label>
                                        <input type="text" class="form-control shadow-sm bg-body rounded" readonly id="updateShipsCarry" name="updateShipsCarry">
                                    </div>
                                </div>
                                <div class="row g-1 mt-3">
                                    <div class="col-6">
                                        <label class="form-label">Operation Start:</label>
                                        <input type="datetime-local" class="form-control shadow-sm bg-body rounded" readonly id="updateOperationStart" name="updateOperationStart">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label">Operation End:</label>
                                        <input type="datetime-local" class="form-control shadow-sm bg-body rounded" readonly id="updateOperationEnd" name="updateOperationEnd">
                                    </div>
                                </div>
                            </form>
                        </div>
